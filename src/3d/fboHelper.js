...
var rawShaderPrefix = (exports.rawShaderPrefix = undefined);
var vertexShader = (exports.vertexShader = undefined);
var copyMaterial = (exports.copyMaterial = undefined);
...
function init(renderer) {
  ...
  rawShaderPrefix = exports.rawShaderPrefix =
  ...
  copyMaterial = exports.copyMaterial = new THREE.RawShaderMaterial({
    ...
    vertexShader:
      (vertexShader = exports.vertexShader =
        rawShaderPrefix + glslify("./quad.vert")),
